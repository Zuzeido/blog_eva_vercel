...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Envía un comentario</h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Guarda mis datos para los siguientes comentarios</label>
        </div>
      </div>
      {error && <p className="text-xs text-red-500">Todos los datos son necesarios</p>}
      <div className="mt-8">
